package com.familyagent.module.tutor.controller;
...
/**
 * Legacy tutor AI proxy endpoint kept for backward compatibility.
 */
@Slf4j
@RestController
...
public class TutorController {
    ...
    @Operation(summary = "Legacy alias for FamilyAgent chat stream")
    @PostMapping(value = "/explain", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public void explainStream(@RequestBody Map<String, Object> request,
        ...
        try (OutputStream outputStream = response.getOutputStream()) {
            ...
            log.warn("Tutor stream failed after response committed: {}", e.getMessage());
