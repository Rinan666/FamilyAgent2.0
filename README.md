# FamilyAgent（家族记忆与软资产传承 AI）

> 面向有传承意识家庭的家族记忆与软资产 AI 系统。

FamilyAgent 的核心目标不是和题库、拍照答疑、作业帮类产品竞争，而是帮助家庭管理更难传承的“软资产”：家族记忆、家风、价值观、长辈经验、人生教训、家庭关系、下一代成长观察和成员理解。

一句话来说：

**FamilyAgent 不是做更强的 AI 家教，而是做更懂这个家族的 AI。**

当前项目处于 **MVP 原型验证阶段**，已经具备在线体验能力，重点验证有传承意识的中产家庭、喜欢记录的新生代用户，以及少量高端家庭是否认可“家族记忆与软资产 AI”这一方向。
...
系统以“家族空间”为主要业务单元。每个家族有自己的成员、经验、成长记录、镜像画像和报告，不同家族的数据互相隔离。早期面向愿意记录和传承的家庭；面向高端家庭时，家族空间也可以承载私有化部署、高端定制、访谈整理和长期知识库建设。
