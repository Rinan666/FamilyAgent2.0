...
```text
Frontend -> Next.js /ai-proxy/tutor/explain
Next.js -> AI Service /ai/tutor/explain
...
| 讲题 SSE | 浏览器 `POST /ai-proxy/tutor/explain` -> AI Service `POST /ai/tutor/explain` |
| 批改 | 浏览器 `POST /ai-proxy/tutor/grade` -> AI Service `POST /ai/tutor/grade` |
| 快速批改 | 浏览器 `POST /ai-proxy/tutor/grade/quick` -> AI Service `POST /ai/tutor/grade/quick` |
| 出题 | 浏览器 `POST /ai-proxy/tutor/generate` -> AI Service `POST /ai/tutor/generate` |
| 数学验证 | 浏览器 `GET /ai-proxy/tutor/math/verify` -> AI Service `GET /ai/tutor/math/verify` |
