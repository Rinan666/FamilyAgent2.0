...
def test_dev_alias_uses_development_defaults():
    ...
    assert settings.auth_fail_open_enabled is False
...
def test_auth_fail_open_defaults_closed_even_in_development():
    assert Settings(app_env="development", auth_fail_open=None).auth_fail_open_enabled is False
